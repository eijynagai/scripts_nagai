...
param = {
    ...
    'qtd_min_cells'     : (10,           'Minimun number of cells per feature'),
    ...
    'norm_scale'        : (10000,       '------'),
    'nFeatures_var'     : (5000,        'Number of variable features'),#2000
    ...
    'markers_path'      : ('/home/nagailae/projects/sc_celegans/vandenbon_v1/script/marker_genes.txt', 'marker genes'),
    'colorplots'        : ('lightgrey', 'Color for plots'),
    'n_var_fea'         : (5000,        'Number of variable features to be identified after normalization')
}
#------ end parameters
