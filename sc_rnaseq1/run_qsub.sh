...
#$ -l s_vmem=80G               #virtual memory required
#$ -l mem_req=80G              #expected memory required; put same as s_vem
#$ -l lmem                 #opt: ljob,lmem,mjob; check using qfree
#$ -e /home/nagailae/projects/sc_celegans/vandenbon_v1/SGE
#$ -o /home/nagailae/projects/sc_celegans/vandenbon_v1/SGE
#$ -N test                  #include name in the; check qstat
...
#working directory
cd /home/nagailae/projects/sc_celegans/vandenbon_v1/

prog1=/home/nagailae/projects/sc_celegans/vandenbon_v1/script/initializationScript.py
prog2=/home/nagailae/projects/sc_celegans/vandenbon_v1/script/step1_qc.R
prog3=/home/nagailae/projects/sc_celegans/vandenbon_v1/script/step2_clustering.R

indir=/home/nagailae/projects/sc_celegans/vandenbon_v1/data
outdir=/home/nagailae/projects/sc_celegans/vandenbon_v1/result
proj=celegans
res=$1
