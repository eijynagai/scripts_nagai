...
dirname <- '/home/nagailae/projects/sc_celegans/seurat3/'

# Parameters load file
source(paste0(dirname,'script/parameters.txt'))
...
counts_matrix_filename = paste0(dirname, 'data/')
...
#iprint(paste0('Number of PCs used:',PCx))
