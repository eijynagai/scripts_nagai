...
#$ -l s_vmem=64G               #virtual memory required
#$ -l mem_req=64G              #expected memory required; put same as s_vem
#$ -l lmem                 #opt: ljob,lmem,mjob; check using qfree
#$ -e /home/nagailae/projects/sc_celegans/seurat3_v3/SGE
#$ -o /home/nagailae/projects/sc_celegans/seurat3_v3/SGE
#$ -N s3_v3                  #include name in the; check qstat
...
#working directory
cd /home/nagailae/projects/sc_celegans/seurat3_v3/

prog1=/home/nagailae/projects/sc_celegans/seurat3_v3/script/initializationScript.py
prog2=/home/nagailae/projects/sc_celegans/seurat3_v3/script/cmd.R
prog3=/home/nagailae/projects/sc_celegans/seurat3_v3/script/cluster.R

indir=/home/nagailae/projects/sc_celegans/seurat3_v3/data
outdir=/home/nagailae/projects/sc_celegans/seurat3_v3/result
proj=celegans
res=$1
