...
param = {
    ...
    'nPCS'              : (200,         'Number of PCs to be calculated'),
    'PCx'               : (150,         'PC threshold'),
    'RES'               : (res,         'Resolution for granularity'),
    'logFC'             : (0.25,        'log fold change'),
    'qvThres'           : (0.001,       'qv threshold'),
    'findmarkers_test'  : ('roc',    'test.use parameter for FindAllMarkers'),  #roc, wilcox
    'markers_path'      : ('/home/nagailae/projects/sc_celegans/seurat3_test/script/marker_genes.txt', 'marker genes'),
